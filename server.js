...
mongoose.connect("mongodb://heroku_5qv8l941:46a1ejlgjegle464h9o5aastum@ds133746.mlab.com:33746/heroku_5qv8l941", {
  useMongoClient: true
});
...
app.get("/scrape", function(req, res) {
  ...
  axios.get("https://reddit.com/r/WTF").then(function(response) {
    ...
    $("#siteTable .thing .entry .top-matter").each(function(i, element) {
